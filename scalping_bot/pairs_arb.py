"""
scalping_bot/pairs_arb.py — Pairs Trading / Statistical Arbitrage (สไตล์ Citadel/quant fund)
...
แยกขาดจากระบบหลัก:
  ...
  - state เก็บใน scalpbot_pairs.json — restart แล้วจัดการไม้เดิมต่อได้
...
_FILE = os.path.join(os.path.dirname(__file__), "scalpbot_pairs.json")
